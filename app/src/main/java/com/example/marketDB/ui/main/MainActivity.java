...
import com.example.marketDB.ui.market_details.MarketDetailsFragment;
...
public class MainActivity extends BaseActivity implements MainActivityView.View,
    ...
    private MarketDetailsFragment marketsDetailsFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marketsDetailsFragment = new MarketDetailsFragment();
