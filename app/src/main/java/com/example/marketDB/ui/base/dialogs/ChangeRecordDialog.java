package com.example.marketDB.ui.base.dialogs;
...
public class ChangeRecordDialog extends DialogFragment {
    ...
    private EditText et_dialog_change_name;
    private EditText et_dialog_change_stock_id;
    private Event event;

    public static ChangeRecordDialog newInstance() {
        return new ChangeRecordDialog();
    }

    public static ChangeRecordDialog newInstance(String body) {
        ChangeRecordDialog fragment = new ChangeRecordDialog();
    ...
    public static ChangeRecordDialog newInstance(String head, String body) {
        ChangeRecordDialog fragment = new ChangeRecordDialog();
        Bundle bundle = new Bundle();
    ...
    public static ChangeRecordDialog newInstance(String head, String body, String positive, String negative) {
        ChangeRecordDialog fragment = new ChangeRecordDialog();
        Bundle bundle = new Bundle();
        bundle.putString(HEAD, head);
        bundle.putString(BODY, body);
...
//        negative = getResources().getString(R.string.dialog_default_negative_string);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        et_dialog_change_name = v.findViewById(R.id.et_market_name);
        btn_confirm = v.findViewById(R.id.btn_confirm);
        btn_confirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (event != null) {
                    if (et_dialog_change_name.getText() != null) {
                        event.confirm();
                    } else {
